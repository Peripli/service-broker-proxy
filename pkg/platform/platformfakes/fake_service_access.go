...
type FakeServiceAccess struct {
	EnableAccessForServiceStub        func(ctx context.Context, context json.RawMessage, serviceGUID string) error
	...
	EnableAccessForPlanStub        func(ctx context.Context, context json.RawMessage, servicePlanGUID string) error
	...
	DisableAccessForServiceStub        func(ctx context.Context, context json.RawMessage, serviceGUID string) error
	...
	DisableAccessForPlanStub        func(ctx context.Context, context json.RawMessage, servicePlanGUID string) error
...
func (fake *FakeServiceAccess) EnableAccessForService(ctx context.Context, context json.RawMessage, serviceGUID string) error {
	...
	fake.enableAccessForServiceArgsForCall = append(fake.enableAccessForServiceArgsForCall, struct {
		...
		context     json.RawMessage
		serviceGUID string
	}{ctx, context, serviceGUID})
	fake.recordInvocation("EnableAccessForService", []interface{}{ctx, context, serviceGUID})
	fake.enableAccessForServiceMutex.Unlock()
	if fake.EnableAccessForServiceStub != nil {
		return fake.EnableAccessForServiceStub(ctx, context, serviceGUID)
	}
	if specificReturn {
		return ret.result1
	}
...
func (fake *FakeServiceAccess) EnableAccessForServiceArgsForCall(i int) (context.Context, json.RawMessage, string) {
	fake.enableAccessForServiceMutex.RLock()
	defer fake.enableAccessForServiceMutex.RUnlock()
	return fake.enableAccessForServiceArgsForCall[i].ctx, fake.enableAccessForServiceArgsForCall[i].context, fake.enableAccessForServiceArgsForCall[i].serviceGUID
}
...
func (fake *FakeServiceAccess) EnableAccessForPlan(ctx context.Context, context json.RawMessage, servicePlanGUID string) error {
	...
	fake.enableAccessForPlanArgsForCall = append(fake.enableAccessForPlanArgsForCall, struct {
		...
		context         json.RawMessage
		servicePlanGUID string
	}{ctx, context, servicePlanGUID})
	fake.recordInvocation("EnableAccessForPlan", []interface{}{ctx, context, servicePlanGUID})
	fake.enableAccessForPlanMutex.Unlock()
	if fake.EnableAccessForPlanStub != nil {
		return fake.EnableAccessForPlanStub(ctx, context, servicePlanGUID)
	}
	if specificReturn {
		return ret.result1
	}
...
func (fake *FakeServiceAccess) EnableAccessForPlanArgsForCall(i int) (context.Context, json.RawMessage, string) {
	fake.enableAccessForPlanMutex.RLock()
	defer fake.enableAccessForPlanMutex.RUnlock()
	return fake.enableAccessForPlanArgsForCall[i].ctx, fake.enableAccessForPlanArgsForCall[i].context, fake.enableAccessForPlanArgsForCall[i].servicePlanGUID
}
...
func (fake *FakeServiceAccess) DisableAccessForService(ctx context.Context, context json.RawMessage, serviceGUID string) error {
	...
	fake.recordInvocation("DisableAccessForService", []interface{}{ctx, context, serviceGUID})
	fake.disableAccessForServiceMutex.Unlock()
	if fake.DisableAccessForServiceStub != nil {
		return fake.DisableAccessForServiceStub(ctx, context, serviceGUID)
	}
	if specificReturn {
		return ret.result1
	}
...
func (fake *FakeServiceAccess) DisableAccessForServiceArgsForCall(i int) (context.Context, json.RawMessage, string) {
	fake.disableAccessForServiceMutex.RLock()
	defer fake.disableAccessForServiceMutex.RUnlock()
	return fake.disableAccessForServiceArgsForCall[i].ctx, fake.disableAccessForServiceArgsForCall[i].context, fake.disableAccessForServiceArgsForCall[i].serviceGUID
}
...
func (fake *FakeServiceAccess) DisableAccessForPlan(ctx context.Context, context json.RawMessage, servicePlanGUID string) error {
	...
	fake.recordInvocation("DisableAccessForPlan", []interface{}{ctx, context, servicePlanGUID})
	fake.disableAccessForPlanMutex.Unlock()
	if fake.DisableAccessForPlanStub != nil {
		return fake.DisableAccessForPlanStub(ctx, context, servicePlanGUID)
	}
	if specificReturn {
		return ret.result1
	}
...
func (fake *FakeServiceAccess) DisableAccessForPlanArgsForCall(i int) (context.Context, json.RawMessage, string) {
	fake.disableAccessForPlanMutex.RLock()
	defer fake.disableAccessForPlanMutex.RUnlock()
	return fake.disableAccessForPlanArgsForCall[i].ctx, fake.disableAccessForPlanArgsForCall[i].context, fake.disableAccessForPlanArgsForCall[i].servicePlanGUID
}
